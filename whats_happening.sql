...
--
-- Host: localhost:8889
-- Generation Time: Apr 06, 2026 at 12:15 AM
...
(13, 'Dance NS', 'files/images/events/DanceNS.jpg', 'Dance for Youth', 'hahahaha', 'Ami Glen', 'ami@NSD.com'),
(14, 'Halifax Gang', 'files/images/events/ski2.jpg', 'Car Gang', 'hahahahahaha', 'Supra Tubro', 'supraturbo@gmail.com'),
(15, 'Halifax Gang', 'files/images/events/ski2.jpg', 'Car Gang', 'hahahahahaha', 'Supra Tubro', 'supraturbo@gmail.com');
...
(1, 1, 'humanS', 'abc123'),
(2, 2, 'locals', 'abc123'),
(3, 3, 'dancer', '\$2y$10$Ho3Vm1tCPmfadfUMOqKS9eQeDJNOBEhby8rcRJAUxcRdpVupyIJ1m'),
(4, 4, 'bands', 'abc123'),
(5, 5, 'noctume', 'abc123'),
(6, 6, 'skate', 'abc123'),
(7, 7, 'soccer', 'abc123'),
...
(13, 13, 'DancerNS', '\$2y$10$RfQf/p17pG0XrI0fb/pt9OEqqMd83PK3vwAPpf3MSwOj42HSRyno.'),
(14, 14, 'BMW', '\$2y$10$Ho3Vm1tCPmfadfUMOqKS9eQeDJNOBEhby8rcRJAUxcRdpVupyIJ1m');
...
--
ALTER TABLE `events`
  MODIFY `EventID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `groups`
  MODIFY `GroupID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `login`
--
ALTER TABLE `login`
  MODIFY `AccountID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
