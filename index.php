              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <?php 
                      ...
                      $JoinSql = "SELECT * FROM events ORDER BY SubmitDate DESC LIMIT 1;";  
                      ...
                      if($allData->num_rows > 0) {
                        while($row = $allData->fetch_assoc()) {
                          ...
                          echo <<<HTML
                            <a href="single-post.php?event_id={$eventNum}" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-2.jpg');">
                              <div class="img-bg-inner">
                                <h2>Latest Added Event</h2>
                                <p><b>$eventTitle</b>: $eventDescription</p>
                              </div>
                            </a>
                          HTML;
                        }
                ...
                <div class="swiper-slide">
                  <?php
                      // get the data from recent event is going to happen soon
                      $JoinSql = "SELECT * FROM events WHERE events.EventDate >= CURDATE() ORDER BY eventDate ASC LIMIT 1;";  
                      $allData = $connect->query($JoinSql);
                      if($allData->num_rows > 0) {
                        while($row = $allData->fetch_assoc()) {
                          $eventTitle =  $row["EventTitle"];
                          ...
                          $eventNum = $row["EventID"];
                          echo <<<HTML
                            <a href="single-post.php?event_id={$eventNum}" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-3.jpg');">
                              <div class="img-bg-inner">
